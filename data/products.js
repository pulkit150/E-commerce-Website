...
class Clothing extends Product{
    ...
    extraInfoHTML(){
      //super.extraInfoHTML(); 2nd way to inherit method from parent class
      return `
...
export function loadProductsFetch(){
  ...
  .then((response)=>{
        ...
        //To get the data we will use JSON
...
export const products = [
  ...
  },
  {
    ...
    name: "Dual zone heavy duty backpack ",
    rating: {
      stars: 4.5,
      count: 3157
    },
  ...
  },
  {
    ...
    name: "Rain protected cost effective umbrella",
    rating: {
      stars: 4.0,
      count: 2876
    },
